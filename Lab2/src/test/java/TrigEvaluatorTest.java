...
public class TrigEvaluatorTest {
    ...
    @Test
    public void secCorrect() {
        ISin mockSin = mock(ISin.class);
        when(mockSin.compute(10.0, 1.0)).thenReturn(10.0);
        when(mockSin.compute(10.0 + (Math.PI / 2), 1.0)).thenReturn(5.0);
        ITrigEvaluator trigEval = new TrigEvaluator(mockSin);
        assertEquals(0.2, trigEval.sec(10.0, 1.0));
    }
    ...
    @Test
    public void secValidation() {
        ITrigEvaluator trigEval = new TrigEvaluator(new Sin());
        assertEquals(Double.NaN, trigEval.sec(Double.NaN, 1.0));
        assertEquals(Double.NaN, trigEval.sec(Double.POSITIVE_INFINITY, 1.0));
        assertEquals(Double.NaN, trigEval.sec(Double.NEGATIVE_INFINITY, 1.0));
        assertEquals(Double.NaN, trigEval.sec(1.0, Double.NaN));
        assertEquals(Double.NaN, trigEval.sec(1.0, Double.POSITIVE_INFINITY));
        assertEquals(Double.NaN, trigEval.sec(1.0, Double.NEGATIVE_INFINITY));
    }
